...
import { SecuritySearchItem } from 'src/app/features/dashboard/data-access/models/security-search-item';
import { SecuritySearchService } from 'src/app/features/dashboard/services/security-search.service';
